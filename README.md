...
- **Роль: Senior Backend Developer** Открыт к предложениям в продуктовых проектах, где backend является основой бизнес-логики и есть возможность влиять на архитектуру и развитие продукта.
